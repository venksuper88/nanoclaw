/**
 * Container Runner for DevenClaw
...
function buildVolumeMounts(
  ...
  // Status line writes Claude Code's pre-calculated context JSON to IPC
  // Inside container, IPC is mounted at /workspace/ipc
  const containerContextFile = '/workspace/ipc/context.json';
  fs.writeFileSync(
    settingsFile,
    JSON.stringify(
      {
        ...
        statusLine: `bash -c 'cat > "${containerContextFile}"'`,
      },
      null,
      2,
    ) + '\n',
